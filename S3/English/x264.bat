...
echo LWLibavVideoSource("D:\Percy\git\ASS Subtitles\S3\English\ÍòÊ¥½Ö_1920x1080_ÍòÊ¥½Ö_%num%.mp4")>>%tmp%\1.avs
echo ConvertToYV12()>>%tmp%\1.avs
echo TextSub("D:\Percy\git\ASS Subtitles\S3\English\ASS_%num%.ass")>>%tmp%\1.avs
...
echo Muxing...
"%x264_path%\ffmpeg.exe" -i ÍòÊ¥½Ö_1920x1080_ÍòÊ¥½Ö_%num%.mp4 -vn -sn -c:a copy -y -map 0:a:0 ÍòÊ¥½Ö_1920x1080_ÍòÊ¥½Ö_%num%_audio.aac
::"%x264_path%\ffmpeg.exe" -i "ÍòÊ¥½Ö_À¶¹â_ÍòÊ¥½Ö_%num%_audio.aac" -ss 00:00:24 -y -c copy "ÍòÊ¥½Ö_À¶¹â_ÍòÊ¥½Ö_%num%_audio_output.aac"
"%x264_path%\mp4box.exe" -add "ASS_%num%.mp4#trackID=1:par=1:1:name=" -add "ÍòÊ¥½Ö_1920x1080_ÍòÊ¥½Ö_%num%_audio.aac" -new "ASS_%num%_Mux.mp4" 
