@echo off
set x264_path=C:\Users\PercyDan\Videos\Ð¡Íè¹¤¾ßÏärev194\tools
set /p num=
echo Processing...
:: Generate avs script
...
%x264_path%\mp4box.exe -add "ASS_%num%.mp4#trackID=1:par=1:1:name=" -add "ÍòÊ¥½Ö_À¶¹â_ÍòÊ¥½Ö_%num%_audio_output.aac" -new "ASS_%num%_Mux.mp4" 
:: Delete temp files
